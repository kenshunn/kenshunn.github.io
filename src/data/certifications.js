...
const certifications = [
  ...
  { name: 'CCNA: Introduction to Networks', issuer: 'Cisco', url: 'https://www.credly.com/badges/7f7eab5b-e3b7-4569-8ec6-ba4a3d344e8b/linked_in_profile', logo: '/images/certs/cisco.svg' },
  { name: 'Full Stack Web Development', issuer: 'Amazon · Coursera', url: 'https://www.coursera.org/account/accomplishments/records/423KN31W0PKL', logo: '/images/certs/coursera.svg' },
  { name: 'The Language of Design: Form and Meaning', issuer: 'CalArts · Coursera', url: 'https://coursera.org/share/ec9fddbde91a463a1459a6882b0f3bfa', logo: '/images/certs/coursera.svg' },
